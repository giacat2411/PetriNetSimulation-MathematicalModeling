...
from Item3_4 import Item3_4

class PetriNetLauncher:
    ...
    def createWidgets(self):
        ...
        self.item3_button['text'] = "ITEM 3, 4"
        self.item3_button['command'] = self.load_3_4
    ...
    def load_3_4(self):
        ...
        self.app = Item3_4(self.windows)
        self.app.master.title("Item 3, 4 - Assignment - Petri Net")
        self.windows.mainloop()
